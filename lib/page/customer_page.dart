...
import 'package:me_arun/page/formClass/customer.dart';
...
class CustomerPage extends StatefulWidget {
  @override
  CustomerPageState createState() => new CustomerPageState();
}

class CustomerPageState extends State<CustomerPage> {
  static var myroute = YcsRoute.customer;
